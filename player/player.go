...
const (
    filePrefix = "/music/"
    root = "/Users/rachel/Documents/goworkspace/musicsync/src/player/music"
)
...
func playerMainFrame(w http.ResponseWriter, r *http.Request) {
    http.ServeFile(w, r, "/Users/rachel/Documents/goworkspace/musicsync/src/player/player.html")
}
